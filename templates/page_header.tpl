        ...
        <div class="navbar-header">
            <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
             <ul class="nav navbar-top-links pull-left pageTitle" style="padding-top: 20px ; padding-left: 10px">
                {if $smarty.session.active_page == 'home_queue'}<li><h3>Home Queue</h3></li>{/if}        
                {if $smarty.session.active_page == 'user_queue'}<li><h3>User Queue</h3></li>{/if}   
                {if $smarty.session.active_page == 'dashboard'}<li><h3>Dashboard</h3></li>{/if}   
                {if $smarty.session.active_page == 'system_setting'}<li><h3>Setting</h3></li>{/if}   
