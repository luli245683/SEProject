...
if(empty($_GET["act"])){
 	if($_GET['province_id']== "'09" || $_GET['province_id'] == "'10"){
 		$candidate_info_list = get_candidate_info_list($_GET['province_id'],$_GET["county_id"]);
		$administrative_list = get_administrative($_GET['province_id'],$_GET["county_id"]);
		$electorate_list = get_administrative($_GET['province_id'],$_GET["county_id"]);
...
if($_GET['act'] == 'update_member_list'){
	...
	$member_list = get_member_list($_GET['province_id'],$_GET['electorate_id'] , $_GET['county_id']);
	$smarty->assign('member_list',$member_list);
